...
# Get DB password from Kubernetes Secret
database_password = os.getenv('DATABASE_PASSWORD')

# Connect to the database
mysql_url = 'localhost'

# NOTE: URL can also be set as Environment Variable
# if needed can do the ssh tunelling to forward port (eg: 8000:localhost:80)
mysql_user = 'root'
database_name = 'Main'
